...
function myLocation(position) {
  ...
  let apiUrlmyLocation1 = `https://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&appid=${apiKey}&units=metric`;
  axios.get(`${apiUrlmyLocation1}`).then(dispalyForcast);
}
